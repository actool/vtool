...
public class ImportAutFile_Theread {
	/***
	...
	public static void main(String[] args) throws IOException {
		/*for (int i = 0; i <2; i++) {
			...
			r1.init(0, 5, "C:\\Users\\camil\\Desktop\\c_model50states.aut", "a"+i);
			r1.start();
		}*/
		long startTime = System.nanoTime();
		String path = "C:\\Users\\camil\\Desktop\\a_model25000states.aut";
		...
		ReadFile r1 = new ReadFile();
		r1.init(0, 500, path, "a");
		r1.start();

		ReadFile r2 = new ReadFile();
		r2.init(501, 1000, path, "b");
		r2.start();
		
		ReadFile r3 = new ReadFile();
		r3.init(1001, 1500, path, "a");
		r3.start();

		ReadFile r4 = new ReadFile();
		r4.init(1501, 2000, path, "b");
		r4.start();
		
		ReadFile r5 = new ReadFile();
		r5.init(2001, 2500, path, "a");
		r5.start();

		ReadFile r6 = new ReadFile();
		r6.init(2501, 3000, path, "b");
		r6.start();
		...
		System.out.println("tempo:" + convert);
